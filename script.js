document.addEventListener('DOMContentLoaded', () => {
    ...
    async function clearCanvasAndSync() {
        ...
        try {
            ...
            console.error("Fehler im Synchronisierungsprozess:", error);
            worldwideStatsDisplay.textContent = previousGlobalText;
            showMessage("Globale Synchronisierung fehlgeschlagen.");
        }
    }
    ...
    async function takeScreenshot() {
        ...
        if (!wasMessageBoxHidden) messageBox.style.display = 'none';
        ...
        try {
            ...
            if (!wasMessageBoxHidden) messageBox.style.display = 'block';
